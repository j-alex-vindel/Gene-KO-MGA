...
# =========== Access Data ====================
data_iaf1260 = read_mat(f"../Metabolic_Networks/Data/MN_IAF/iAF1260.mat")
...
MN_iaf1260 = MN(S=S,LB=LB,UB=UB,Rxn=rxn,Met=met,Name=iaf1260,KO=knockout,biomass= biomas, chemical=chemical)
