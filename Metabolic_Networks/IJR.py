...
data = read_mat(f"../Metabolic_Networks/Data/MN_IJR/iJR904.mat")
...
MN_ijr904 = MN(S=S,LB=LB,UB=UB,Met=Met,Rxn=Rxn,biomass=biomas,chemical=chemical,Name=ijr904,KO=knockout)
