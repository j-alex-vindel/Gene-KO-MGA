...
# =========== Access Data ====================
data_ijo1366 = read_mat(f"../Metabolic_Networks/Data/MN_IJO/iJO1366.mat")
...
MN_ijo1366 = MN(S=S,LB=LB,UB=UB,Rxn=rxn,Met=met,Name=ijo1366,KO=knockout,biomass= biomas, chemical=chemical)
